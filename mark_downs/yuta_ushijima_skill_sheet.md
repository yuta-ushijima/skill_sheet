...
| 年齢 | 31歳 |
| 配偶者 | 有 |
| 得意分野 | Railsを用いたAPI実装およびインフラ自動化 |
| 得意技術 |Ruby/Rails/React/Docker/AWS/Ansible/Terraform/CircleCI |


## 自己PR
RubyonRailsを用いたWebアプリケーションを中心に要件定義から結合テストまで一連の工程を経験しています。

## 言語別経験年数

| プログラミング言語 | 年数 |
|:-----------:|:------------:|
| Ruby/RubyonRails | 3年程度 |
| Ansible | 1年程度 |
| Terraform | 1年程度 |
| AWS | 2年程度 |
| Docker | 1.5年程度 |
